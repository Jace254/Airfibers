...
<template>
  ...
  <div class="lg:hidden block pos-initial h-auto overflow-hidden align-top opacity-100 ">
    <div v-for="navItem, idx in navItems" :key="idx" class="mx-[1px] pb-[1px] pt-[0.05px]">
      <NavigationItem :icon="navItem.icon" :title="navItem.title" :sub-items="navItem.subItems" :to="navItem.to" />
    </div>
  </div>
</template>
